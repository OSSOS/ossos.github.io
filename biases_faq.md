...
Labelled versions of the plot above are available, which identify all the objects: <a href="images/OSSOS_names_press_top_down.png">labelled</a> with <a href="http://www.minorplanetcenter.net/">Minor Planet Center</a> designations or <a href="images/OSSOS_internal_names_press_top_down.png">with the OSSOS designations.</a> 
